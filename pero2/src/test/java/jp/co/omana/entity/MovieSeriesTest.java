...
public class MovieSeriesTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MovieSeries.class).id(1, 1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_movieInfo() throws Exception {
        jdbcManager.from(MovieSeries.class).leftOuterJoin(movieInfo()).id(1, 1).getSingleResult();
    }
}